...
variable "private_loadbalancer_subnets" {
  description = "A list of private_loadbalancer subnets inside the VPC"
  type        = list(string)
  default     = []
}

variable "private_loadbalancer_subnet_assign_ipv6_address_on_creation" {
  description = "Specify true to indicate that network interfaces created in the specified subnet should be assigned an IPv6 address. Default is `false`"
  type        = bool
  default     = false
}

variable "private_loadbalancer_subnet_enable_dns64" {
  description = "Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet should return synthetic IPv6 addresses for IPv4-only destinations. Default: `true`"
  type        = bool
  default     = true
}

variable "private_loadbalancer_subnet_enable_resource_name_dns_aaaa_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records. Default: `true`"
  type        = bool
  default     = true
}

variable "private_loadbalancer_subnet_enable_resource_name_dns_a_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS A records. Default: `false`"
  type        = bool
  default     = false
}

variable "private_loadbalancer_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 private_loadbalancer subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list(string)
  default     = []
}

variable "private_loadbalancer_subnet_ipv6_native" {
  description = "Indicates whether to create an IPv6-only subnet. Default: `false`"
  type        = bool
  default     = false
}
...
variable "private_loadbalancer_subnet_names" {
  description = "Explicit values to use in the Name tag on private_loadbalancer subnets. If empty, Name tags are generated"
  type        = list(string)
  default     = []
}

variable "private_loadbalancer_subnet_suffix" {
  description = "Suffix to append to private_loadbalancer subnets name"
  type        = string
  default     = "private_loadbalancer"
}

variable "private_loadbalancer_subnet_tags" {
  description = "Additional tags for the private_loadbalancer subnets"
  type        = map(string)
  default     = {}
}

variable "private_loadbalancer_subnet_tags_per_az" {
  description = "Additional tags for the private_loadbalancer subnets where the primary key is the AZ"
  type        = map(map(string))
  default     = {}
}

variable "private_loadbalancer_route_table_tags" {
  description = "Additional tags for the private_loadbalancer route tables"
  type        = map(string)
  default     = {}
}
...
variable "private_loadbalancer_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for private_loadbalancer subnets"
  type        = bool
  default     = false
}

variable "private_loadbalancer_inbound_acl_rules" {
  description = "private_loadbalancer subnets inbound network ACLs"
  type        = list(map(string))
  default = [
    {
      rule_number = 100
...
variable "private_loadbalancer_outbound_acl_rules" {
  description = "private_loadbalancer subnets outbound network ACLs"
  type        = list(map(string))
  default = [
    {
      rule_number = 100
...
variable "private_loadbalancer_acl_tags" {
  description = "Additional tags for the private_loadbalancer subnets network ACL"
  type        = map(string)
  default     = {}
}
...
variable "eks_control_plane_subnets" {
  description = "A list of eks_control_plane subnets inside the VPC"
  type        = list(string)
  default     = []
}
...
variable "eks_control_plane_subnet_enable_dns64" {
  description = "Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet should return synthetic IPv6 addresses for IPv4-only destinations. Default: `true`"
  type        = bool
  default     = true
}

variable "eks_control_plane_subnet_enable_resource_name_dns_aaaa_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records. Default: `true`"
  type        = bool
  default     = true
}

variable "eks_control_plane_subnet_enable_resource_name_dns_a_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS A records. Default: `false`"
  type        = bool
  default     = false
}
...
variable "eks_control_plane_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 eks_control_plane subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list(string)
  default     = []
}

variable "eks_control_plane_subnet_ipv6_native" {
  description = "Indicates whether to create an IPv6-only subnet. Default: `false`"
  type        = bool
  default     = false
}
...
variable "eks_control_plane_subnet_names" {
  description = "Explicit values to use in the Name tag on eks_control_plane subnets. If empty, Name tags are generated"
  type        = list(string)
  default     = []
}

variable "eks_control_plane_subnet_suffix" {
  description = "Suffix to append to eks_control_plane subnets name"
  type        = string
  default     = "eks_control_plane"
}

variable "eks_control_plane_subnet_tags" {
  description = "Additional tags for the eks_control_plane subnets"
  type        = map(string)
  default     = {}
}

variable "eks_control_plane_subnet_tags_per_az" {
  description = "Additional tags for the eks_control_plane subnets where the primary key is the AZ"
  type        = map(map(string))
  default     = {}
}

variable "eks_control_plane_route_table_tags" {
  description = "Additional tags for the eks_control_plane route tables"
  type        = map(string)
  default     = {}
}
...
variable "eks_control_plane_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for eks_control_plane subnets"
  type        = bool
  default     = false
}

variable "eks_control_plane_inbound_acl_rules" {
  description = "eks_control_plane subnets inbound network ACLs"
  type        = list(map(string))
  default = [
    {
      rule_number = 100
...
variable "eks_control_plane_outbound_acl_rules" {
  description = "eks_control_plane subnets outbound network ACLs"
  type        = list(map(string))
  default = [
    {
      rule_number = 100
...
variable "eks_control_plane_acl_tags" {
  description = "Additional tags for the eks_control_plane subnets network ACL"
  type        = map(string)
  default     = {}
}
